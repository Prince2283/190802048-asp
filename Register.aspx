...
<body>
    <h2><center>Welcome to Admin Registration</center></h1>
	<div class="container">
	  ...
	  <div class="col-xl-6 col-lg-6 col-md-6">
    		...
    		<div class="card o-hidden border-0 shadow-lg my-5">
				...
				<form id="form1" runat="server">
                            ...
                            <div class="form-group">
                                <asp:TextBox ID="TextBox4" runat="server" class="form-control form-control-user" placeholder="Enter Password Again..."></asp:TextBox>
            			    </div>
                            <asp:Button ID="Button1" runat="server" 
                                class="btn btn-primary btn-user btn-block" Text="Register" 
